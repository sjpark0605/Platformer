var PlayerEntity = me.ObjectEntity.extend({
  init: function(x, y, settings) {
    ...
    this.setMaxVelocity(5, 12);
    this.setFriction(0, 0.001);
  },
  update: function() {
    if (me.input.isKeyPressed('left')) { this.flipX(true); this.vel.x-=0.2; } 
    else if (me.input.isKeyPressed('right')) { this.flipX(false); this.vel.x+=0.2; } 
    else { this.vel.x = 0; };
